...
/**
 * This is the item provider adapter for a {@link behaviourMM.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider extends StatementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviourMMPackage.Literals.LOOP__STATEMENT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Loop_type") + " " + loop.getId();
	}
