...
/**
 * This is the item provider adapter for a {@link behaviourMM.intVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class intVariableItemProvider extends VariableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviourMMPackage.Literals.INT_VARIABLE__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(intVariable.class)) {
			case BehaviourMMPackage.INT_VARIABLE__VALUE:
