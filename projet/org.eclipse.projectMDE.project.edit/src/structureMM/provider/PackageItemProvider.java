...
/**
 * This is the item provider adapter for a {@link structureMM.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructureMMPackage.Literals.PACKAGE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((structureMM.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(structureMM.Package.class)) {
