...
/**
 * This is the item provider adapter for a {@link structureMM.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructureMMPackage.Literals.METHOD__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructureMMPackage.Literals.METHOD__INPUTS);
			childrenFeatures.add(StructureMMPackage.Literals.METHOD__STATEMENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Method.class)) {
			case StructureMMPackage.METHOD__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case StructureMMPackage.METHOD__INPUTS:
			case StructureMMPackage.METHOD__STATEMENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructureMMPackage.Literals.METHOD__INPUTS,
