...
/**
 * This is the item provider adapter for a {@link structureMM.doubleAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class doubleAttributeItemProvider extends AttributeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_doubleAttribute_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_doubleAttribute_value_feature", "_UI_doubleAttribute_type"),
				 StructureMMPackage.Literals.DOUBLE_ATTRIBUTE__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(doubleAttribute.class)) {
			case StructureMMPackage.DOUBLE_ATTRIBUTE__VALUE:
