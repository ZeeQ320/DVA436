 ...
 * </p>
 * <ul>
 *   <li>{@link behaviourMM.impl.ConditionnalImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConditionnalImpl extends StatementImpl implements Conditionnal {
	/**
	...
	protected EClass eStaticClass() {
		return BehaviourMMPackage.Literals.CONDITIONNAL;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this, BehaviourMMPackage.CONDITIONNAL__STATEMENT);
		}
		return statement;
	}
